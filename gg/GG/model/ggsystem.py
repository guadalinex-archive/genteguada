...
class GGSystem(dMVC.model.Model):
  ...
  def loadData(self):
    ...
    myDoor1 = GG.model.door.GGDoor(GG.utils.DOOR_DOWN_SPRITE, [53, 135], [3, 0, 0], [700, 30], [0, 0], "down", room2)
    myDoor2 = GG.model.door.GGDoor(GG.utils.DOOR_DOWN_SPRITE, [53, 135], [3, 0, 0], [700, 30], [0, 0], "down", room1)
