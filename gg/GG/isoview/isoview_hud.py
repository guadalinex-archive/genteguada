...
class IsoViewHud(isoview.IsoView): 
  ...
  def paintAdminOptions(self):
    ...
    createObjectButton = guiobjects.OcempImageButtonTransparent(filePath, "Eliminar habitaciÃ³n", self.showTooltip, self.removeTooltip)
    ...
    createObjectButton = guiobjects.OcempImageButtonTransparent(filePath, "Crear habitaciÃ³n", self.showTooltip, self.removeTooltip)
